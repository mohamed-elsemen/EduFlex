...
const AdminInstructors = () => {
    ...
    return (
        <div>
            ...
            <h1 className="ml-[8%] mt-[20px] text-[1.8vw] font-bold">Instructors</h1>
            ...
            <div className="w-[20%] bg-gradient-to-b from-[#D0D0D0] to-[#f2f2f28c] ml-[10%] my-4 rounded-[10px]">
                <img src="../src/assets/admin_icons/instructor_col.PNG" className="m-5 mr-3 w-[2.4vw] inline"/>
                <span className="text-[#1A1A1A] font-[600] text-[1.6vw] relative top-[5px]">Total Instructors</span>
                <div className="m-auto mx-[30%] relative bottom-[20px]">
                    <span className="text-[#808080] font-bold text-[1.3vw]">500</span>
                    <img src="../src/assets/admin_icons/trend.PNG" className="relative bottom-[0.5vw] ml-[10%] w-[2vw] inline"/>
                </div>
            </div>
            <h1 className="ml-[8%] mt-[50px] text-[1.8vw] font-bold">Registered Instructors</h1>
            <table className="mx-[10%] m-auto w-[80%] text-center mt-[20px] table-fixed">
                <thead className="bg-[#00BF63] text-white">
                <tr>
                    <th className="py-3 rounded-l-[10px]">Instructor ID</th>
                    <th>Name</th>
                    <th>E-Mail</th>
                    <th>No.Of Courses</th>
